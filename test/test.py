...
file_names = ["JdP_001_input", "JdP_001_input", "JdP_001_input"]  # Update with actual file names

# Path to the analysis script
analysis_script = "./analysis_script.py"  # Update with the actual path

# Path to the decryption script
decryption_script = "./decryption_script.py"  # Update with the actual path
