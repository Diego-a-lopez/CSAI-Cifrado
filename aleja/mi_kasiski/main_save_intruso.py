...
if __name__ == "__main__":
    ...
    if subcadenas_filtradas:
        ...
        maximos_comunes_divisores = []  # Lista para almacenar los máximos comunes divisores
        for subcadena in subcadenas_filtradas:
            ...
            maximos_comunes_divisores.extend(diferencias)  # Agregar diferencias a la lista de MCDs
        
        
        # FASE 3
        # Calcular el MCD de todos los valores en la lista maximos_comunes_divisores
        
        #quit()                                                                           126 INTRUSO
        #maximos_comunes_divisores = [28, 200, 100, 320, 80, 164, 12, 16, 168, 112, 136, 88, 126, 68, 8, 28, 20, 48, 32, 256, 104, 72, 276, 156, 32]
        print(maximos_comunes_divisores)
        if maximos_comunes_divisores:
            mcd_resultado = maximos_comunes_divisores[0]
            for valor in maximos_comunes_divisores[1:]:
                mcd_resultado = gcd(mcd_resultado, valor)
            print("Máximo Común Divisor de todas las diferencias:", mcd_resultado)
        else:
            print("No se encontraron diferencias para calcular el MCD.")
